...
class BlinkAnimation(AnimationInterface):
    def __init__(self, refresh_function, frequency, image_folder, static_image_name):
        super(BlinkAnimation, self).__init__(refresh_function, frequency, image_folder, static_image_name)
        ...
        frequency_array = [0.02, 0.02, 0.02, 0.02,
                           0.02, 0.02, 0.02, 0.02,
                           0.02, 0.02]
